...
+ (void)drawShoulders;
{
    ...
    UIColor* selfskinBaseColor = [UIColor colorWithRed: 0.929 green: 0.763 blue: 0.559 alpha: 1];
    CGFloat selfskinBaseColorRGBA[4];
    [selfskinBaseColor getRed: &selfskinBaseColorRGBA[0] green: &selfskinBaseColorRGBA[1] blue: &selfskinBaseColorRGBA[2] alpha: &selfskinBaseColorRGBA[3]];

    UIColor* selfskinShadowColor = [UIColor colorWithRed: (selfskinBaseColorRGBA[0] * 0.8) green: (selfskinBaseColorRGBA[1] * 0.8) blue: (selfskinBaseColorRGBA[2] * 0.8) alpha: (selfskinBaseColorRGBA[3] * 0.8 + 0.2)];
...
+ (UIImage*)imageOfShoulders;
{
    ...
    [CHAvatarDrawingData drawShoulders];
